...
ROUTE_TRACK = "Jälki (GPX tai GeoJSON)"
ROUTE_TRACK_KEEP = "Tyhjä = nykyinen jälki säilyy."
...
ROUTE_CREATE_NEEDS_TRACK = "Uusi reitti tarvitsee jäljen (GPX tai GeoJSON)."
METRIC_LENGTH = "Pituus"
METRIC_ASCENT = "Nousu"
METRIC_IMAGES = "Kuvia"
NO_ELEVATIONS = "Jäljessä ei ole korkeuksia; nousu ja profiili jäävät pois (P11)."
BUTTON_FILL_ELEVATIONS = "Täydennä korkeudet MML:n korkeusmallista"
ELEVATIONS_KEY_MISSING = "Lisää MML_API_KEY .env-tiedostoon, niin korkeudet voi täydentää."
ELEVATIONS_FILLING = "Haetaan korkeusmallia Maanmittauslaitokselta…"
ELEVATIONS_FILLED = "Korkeudet täydennetty: {report}"
ELEVATIONS_FILL_FAILED = "Korkeuksien täydennys epäonnistui"
